...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GMSArtifactStorageSpec) DeepCopyInto(out *GMSArtifactStorageSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GMSArtifactStorageSpec.
func (in *GMSArtifactStorageSpec) DeepCopy() *GMSArtifactStorageSpec {
	if in == nil {
		return nil
	}
	out := new(GMSArtifactStorageSpec)
	in.DeepCopyInto(out)
	return out
}
