...
def _build_parser() -> argparse.ArgumentParser:
    ...
    load_p.add_argument(
        ...
        help=(
            ...
            "'local-ssd-striped' uses the CPU-staged path across same-node "
            "local SSD roots; "
            "'local-ssd-pinned' uses reusable pinned host buffers and direct "
            "cudaMemcpyAsync copies from same-node local SSD roots; "
